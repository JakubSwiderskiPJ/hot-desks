...
public interface IReservationInterface
{
    ...
    public Task BookADesk(Desk desk, DateOnly dateFrom, DateOnly dateTo, Employee employee);
    public Task ChangeDesk(Desk previousDesk, Desk newDesk, Employee employee);
}